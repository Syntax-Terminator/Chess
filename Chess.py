...
bp = Piece('b', 'p', 'Assets/black_pawn.png')
wp = Piece('w', 'p', 'Assets/white_pawn.png')
bk = Piece('b', 'k', 'Assets/black_queen.png')
wk = Piece('w', 'k', 'Assets/white_queen.png')
br = Piece('b', 'r', 'Assets/black_rook.png')
wr = Piece('w', 'r', 'Assets/white_rook.png')
bb = Piece('b', 'b', 'Assets/black_bishop.png')
wb = Piece('w', 'b', 'Assets/white_bishop.png')
bq = Piece('b', 'q', 'Assets/black_king.png')
wq = Piece('w', 'q', 'Assets/white_king.png')
bkn = Piece('b', 'kn', 'Assets/black_knight.png')
wkn = Piece('w', 'kn', 'Assets/white_knight.png')
...
## Checks a 5x5 grid around the piece and uses algorithm to see if if a move is valid. Valid moves will be a distance of sqrt(5) from centre
